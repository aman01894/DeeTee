...
class PassSheetAdapter(
    private val statuses: List<List<Any>>,
    private val onItemClicked: (Int) -> Unit // Lambda to notify activity of the click
) : RecyclerView.Adapter<PassSheetAdapter.StatusViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StatusViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_pass_sheet, parent, false)
    ...
    override fun onBindViewHolder(holder: StatusViewHolder, position: Int) {
        ...
        // Set data
        holder.txtOperation.text = status.get(1).toString()
